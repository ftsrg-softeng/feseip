...
import { APhaseInstance } from '../interfaces/phase-instance.interface'
...
export type PhaseInstanceDocument = HydratedDocument<PhaseInstance>

@Schema({
    discriminatorKey: 'type'
})
export class PhaseInstance extends APhaseInstance {
    @Prop({ required: true, auto: true })
    _id: mongoose.Schema.Types.ObjectId

    @ReferenceProp(CourseInstance, { array: true })
...
export const PhaseInstanceSchema = SchemaFactory.createForClass(PhaseInstance)
